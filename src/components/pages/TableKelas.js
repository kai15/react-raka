...
class Pages extends Component {
  ...
  async remove(id) {
    await fetch(`/api/v1/kelass/${id}`, {
      ...
      //   .then(() => {
      //     let updatedKelas = [...this.state.kelas].filter(i => i.id !== id);
      //     this.setState({kelas: updatedKelas});})
      // });
      ...
      <div className="main-content">
        ...
        <div className="padding-15px grid grid-2x">
          ...
          <div className="col-2 content-right">
            ...
            <Button className="btn btn-blue margin-left-10px" tag={Link} to="/kelass/add"><i className='fa fa-1x fa-plus'></i></Button>
